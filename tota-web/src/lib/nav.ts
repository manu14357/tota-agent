...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Tools: Core', slug: 'reference/built-in-tools/core' },
      { title: 'Tools: Automation', slug: 'reference/built-in-tools/automation' },
      { title: 'Tools: Knowledge', slug: 'reference/built-in-tools/knowledge' },
      { title: 'Tools: System + Secrets', slug: 'reference/built-in-tools/system' },
      { title: 'Tools: Voice + Calendar', slug: 'reference/built-in-tools/voice-calendar' },
      { title: 'Tools: MCP + Output', slug: 'reference/built-in-tools/mcp-output' },
      { title: 'Configuration', slug: 'reference/configuration' },
      { title: 'Config: Web Search', slug: 'reference/configuration/web-search' },
      { title: 'Config: REST API', slug: 'reference/configuration/api-channel' },
      { title: 'Config: Calendar', slug: 'reference/configuration/calendar' },
      { title: 'Config: Voice', slug: 'reference/configuration/voice' },
      { title: 'Config: Browser', slug: 'reference/configuration/browser' },
      { title: 'Config: Computer-Use', slug: 'reference/configuration/computer-use' },
      { title: 'Config: Secrets Vault', slug: 'reference/configuration/secrets-vault' },
      { title: 'Config: Loop Guard', slug: 'reference/configuration/loop-guard' },
      { title: 'Config: Budget', slug: 'reference/configuration/budget' },
      ...
      { title: 'Web Search', slug: 'reference/web-search' },
    ],
  },
]
