...
|------|-----|-------------|
| [Chat](/docs/web-ui/chat) | `/chat` | Full conversation interface with streaming, slash commands, file upload, voice input |
| [Dashboard](/docs/web-ui/dashboard) | `/dashboard` | Agent status, model, uptime, token budget |
| [Memory](/docs/web-ui/memory) | `/memory` | Browse and manage Second Brain facts |
| [Scheduler](/docs/web-ui/scheduler) | `/scheduler` | View and cancel scheduled tasks |
| [Skills](/docs/web-ui/skills) | `/skills` | Installed skills list |
| [Settings](/docs/web-ui/settings) | `/settings` | Provider and API key status |
| [Logs](/docs/web-ui/logs) | `/logs` | Live log viewer with severity filter |
