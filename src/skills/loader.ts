...
export class SkillLoader {
  ...
  private seedTemplate(): void {
    ...
    const content = `---
name: template-skill
description: A template skill for tota. Use this as a starting point to create your own skills.
version: 0.1.0
allowed-tools:
  - read_file
  - list_dir
...
This is a template skill for tota. Copy this directory and edit SKILL.md to create your own skill.

## What It Does

Describe what this skill enables tota to do. When invoked via the use_skill tool, these instructions are injected into tota's context as guidance.

## Instructions

1. Step one of what tota should do
2. Step two
